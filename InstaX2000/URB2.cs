...
{
    public partial class URB2 : Form
    {
        //Declaring variables
        ...
        public URB2(int one, int two, int three, int extra, int wagonnumber, int seat1, int seat2, int seat3, string wagonnr)
        {
            InitializeComponent();
            this.place1 = one;
            this.place2 = two;
        ...
        private void btnDone_Click_1(object sender, EventArgs e)
        {
            ...
            InstaControlLibrary.Manager.requestedWagonResultControl(InstaControlLibrary.WagonType.URB2, chair1damm, chair1Fla, chair1Skr, chair2damm, chair2Fla, chair2Skr, chair3damm, chair3Fla, chair3Skr, extra1, extra2, extra3, ExtraName, m_wagonnumber, seat1nr, seat2nr, seat3nr, m_wagonnr);
            this.Close();
        }        
    }
}
