...
namespace InstaX2000
{
    public partial class UA2 : Form
    {
        ...
        public UA2(int one, int two, int three, int extra, int wagonnumber, int seat1, int seat2, int seat3, string wagonnr)
        {
            InitializeComponent();
            this.place1 = one;
            this.place2 = two;
        ...
        {
            lblPosition1.Text = place1.ToString();
            lblStolnummer2.Text = place2.ToString();
            lblStol3nummer.Text = place3.ToString();
            if (place4 == 1)
            {
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            InstaControlLibrary.Manager.requestedWagonResultControl(InstaControlLibrary.WagonType.UA2, chair1damm, chair1Fla, chair1Skr, chair2damm, chair2Fla, chair2Skr, chair3damm, chair3Fla, chair3Skr, extra1, extra2, extra3, ExtraName, m_wagonnumber, seat1nr, seat2nr, seat3nr, m_wagonnr);
            this.Close();
        }
